...
<html lang="pt-br">
  <head>
    ...
    <style>
		...
		height: 100%;
		z-index: 9999;
		background: url('../../images/logo_horizon_fundo_azul.gif') 50% 50% no-repeat;
	  }
      .rocket {
    ...
    <nav class="navbar navbar-expand-lg bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="../../index.php"><img src="../../images/logo_horizon.png" width="100" height="100"></a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                <li class="nav-item">
                    <a class="nav-link active" style="color:#00C2CB" aria-current="page" href="../../index.php">Menu</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " style="color:#00C2CB" href="add_dados">Adicionar Dados</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " style="color:#00C2CB" href="get_dados">Gerar Documentos</a>
                </li> 
                <li>
                    <a class="nav-link " style="color:#00C2CB" href="update_dados">Editar Dados</a>
                </li>         
            </ul>
            </div>
        </div>
                        ...
                        <form method="post" action="add_dados">    
                            <div class="form row">
                                <label for="cliente_empresa_nome" class="col-sm-3 col-form-label text-light text-center"><strong> Empresa</strong></label>
                                    <div class="form-group col-md-6">
                                        <input type="text" required name="cliente_empresa_nome" <?php set_value('empresa', $data['cliente_empresa_nome'])?> class="form-control" id="cliente_empresa_nome">
                                    </div>
                            </div>
                            <br>
                            <div class="form row">
                                <label for="presidente_cliente" class="col-sm-3 col-form-label text-light text-center"><strong> Presidente</strong></label>
                                    <div class="form-group col-md-6">
                                        <input type="text" required name="presidente_cliente" <?php set_value('presidente_cliente', $data['presidente_cliente'])?> class="form-control" id="presidente_cliente">
                                    </div>
                            </div>
                            <br>
                            <div class="form row">
                                <label for="cnpj" class="col-sm-3 col-form-label text-light"><strong> CNPJ</strong></label>
                                    <div class="form-group col-md-6">
                                        <input type="text" required  name="cnpj" class="form-control" <?php set_value('cnpj', $data['cnpj'])?> id="cnpj" data-mask=" 99.999.999/0001-99">
                                    </div>
                                    <br>
                            </div>
                            <br>
                            <div class="form row">
                                <label for="cpf" class="col-sm-3 col-form-label text-light"><strong> CPF do Presidente</strong></label>
                                    <div class="form-group col-md-6">
                                        <input type="text" required  name="cpf" class="form-control" <?php set_value('cpf', $data['cpf'])?> id="cpf" data-mask=" 999.999.999-01">
                                    </div>
                                    <br>
                            </div>
                            <br>
                            <div class="form row">
                                <label for="endereco_presidente" class="col-sm-3 col-form-label text-light text-center"><strong> Endereço Presidente</strong></label>
                                    <div class="form-group col-md-6">
                                        <input type="text" required  name="endereco_presidente" <?php set_value('endereco_presidente', $data['endereco_presidente'])?> class="form-control" id="endereco_presidente">
                                    </div>
                                    <br>
                            </div>
                            <br>
                            <div class="form row">
                                <label for="endereco" class="col-sm-3 col-form-label text-light text-center"><strong> Endereço Empresa</strong></label>
                                    <div class="form-group col-md-6">
                                        <input type="text" required  name="endereco" <?php set_value('endereco', $data['endereco'])?> class="form-control" id="endereco">
                                    </div>
                                    <br>
                            </div>
                            <br>
                            <div class="form row">
                                <label for="cep" class="col-sm-3 col-form-label text-light"><strong> CEP</strong></label>
                                    <div class="form-group col-md-6">
                                        <input type="text" required  name="cep" <?php set_value('cep', $data['endereco'])?> class="form-control" id="cep" data-mask="99999-999">
                                    </div>
                                    <br>
                            </div>
                            <br>
        ...
        <div class="container text-center">
            ...
            <div>
                ...
                Todos os direitos deste Site estão reservados<br>
                 Powered by <i class="fa fa-registered fa-xs"></i> Autotech 
                </p>
